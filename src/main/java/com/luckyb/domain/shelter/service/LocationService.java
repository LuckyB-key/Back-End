...
public class LocationService {
   ...
   */
  public boolean isWithinRadius(double lat1, double lng1, double lat2, double lng2,
      double radiusKm) {
  ...
  /**
   * 카카오맵 API를 사용한 도보 거리 계산 (추후 구현 예정) 현재는 직선 거리로 대체
   */
  ...
  /**
   * 카카오맵 API를 사용한 도보 시간 계산 (추후 구현 예정) 현재는 평균 도보 속도로 계산
   */
