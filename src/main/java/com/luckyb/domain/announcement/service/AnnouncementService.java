...
public class AnnouncementService {
     ...
     */
    @Transactional
    public AnnouncementUpdateResponse updateAnnouncement(String announcementId, AnnouncementUpdateRequest request) {
        Announcement announcement = announcementRepository.findById(announcementId)
                .orElseThrow(() -> new AnnouncementNotFoundException("공지사항을 찾을 수 없습니다. ID: " + announcementId));
