  ...
  public UserMeResponse updateUserInfo(String userId, UserMeUpdateRequest request) {
    ...
    if (request.getNickname() != null &&
      ...
      throw new IllegalArgumentException(
          ErrorCode.DUPLICATE_NICKNAME.getMessage() + ": " + request.getNickname());
    }
    ...
    if (request.getEmail() != null &&
      ...
      throw new IllegalArgumentException(
          ErrorCode.DUPLICATE_EMAIL.getMessage() + ": " + request.getEmail());
    }

    user.updateInfo(request.getNickname(), request.getEmail(), request.getRole(),
